...
static const _BlueprintOculusSonarFire_type_support_symbol_names_t _BlueprintOculusSonarFire_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, wamv_interfaces, msg, BlueprintOculusSonarFire)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, wamv_interfaces, msg, BlueprintOculusSonarFire)),
  }
};
...
{
  return &::wamv_interfaces::msg::rosidl_typesupport_cpp::BlueprintOculusSonarFire_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, wamv_interfaces, msg, BlueprintOculusSonarFire)() {
  return get_message_type_support_handle<wamv_interfaces::msg::BlueprintOculusSonarFire>();
}
