...
bool wamv_interfaces__msg__blueprint_oculus_sonar_image__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("wamv_interfaces.msg._blueprint_oculus_sonar_image.BlueprintOculusSonarImage", full_classname_dest, 75) == 0);
  }
  wamv_interfaces__msg__BlueprintOculusSonarImage * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // is_bigendian
    ...
    assert(PyLong_Check(field));
    ros_message->is_bigendian = (int16_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // data
...
{
  /* NOTE(esteve): Call constructor of BlueprintOculusSonarImage */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("wamv_interfaces.msg._blueprint_oculus_sonar_image");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "BlueprintOculusSonarImage");
  ...
  {  // is_bigendian
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->is_bigendian);
    {
